...
const Contact = () => {
    return (
  <div className='bg-slate-100 py-4 lg:px-20 px-6'>
    <Helmet>
                <title>Tourist Guide BD | CONTACT</title>
            </Helmet>
          <div className="container mx-auto mt-8">
    <h1 className="text-3xl font-bold text-green-700 mb-4">Contact Tourist Guide</h1>
    ...
    <form method="post" className="lg:max-w-md">
        ...
        <button disabled type="submit" className="bg-green-600 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">Send Message</button>
    </form>
</div>
  </div>
    );
