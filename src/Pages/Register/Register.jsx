            ...
            <div className="hero p-10 bg-base-200">
                <div className="hero-content flex-col lg:flex-row justify-between">
                    ...
                    <img className='w-80' src={logo} alt="" />
                        ...
                        <p className="py-2 font-Ephesis text-lg">We are thrilled to have you join us. Sign up now and unlock a world of possibilities. Experience the best of what we have to offer and connect with like-minded individuals. Your journey begins here.
                    ...
                    <div className="card w-[60%] flex-shrink-0 max-w-lg shadow-2xl bg-base-100">
                        ...
                        <h1 className="text-5xl font-bold text-center mb-10">Register Now!</h1>
                            ...
                            <div className="form-control mt-6">
                                <button disabled={isDisabled} className={`w-full  font-semibold text-white h-14  ${isDisabled ? "bg-gray-600" : " bg-gradient-to-r from-green-900 via-green-700 to-green-200  hover:scale-110 transition-transform"}`}>Submit</button>
                            </div>
                            ...
                            <div className="text-center pt-10">
                                <small className="font-medium text-black">Already Have an Account?  Please<Link to="/login" className="text-green-900 ml-2 font-bold"><button onClick={goToTop}>Login</button></Link></small>
                            </div>
